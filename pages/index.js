...
function Index() {
  ...
  return (
    <header className="flex h-full flex-col items-center justify-center sm:max-lg:min-h-[85vh] subscriber_mid">
      ...
      <div>
      {
        ...
        (<div className='h-auto w-full flex justify-center items-center my-4 flex-col'>
           <div className='w-full sm:w-[50vw]  lg:w-[30vw] h-full  flex flex-col gap-y-3 items-center p-4 sm:p-8'>
             <h3 className='font-bold text-xl my-4 text-center'>LOGIN YOUR DASHBOARD</h3> 
    ...
    />
       ...
       (<div className='h-auto w-full flex flex-col justify-center items-center my-4'>
          <div className='w-full sm:w-[50vw]  lg:w-[30vw] h-full  flex flex-col gap-y-3 items-center p-4 sm:p-8'>
          <h3 className='font-bold text-[26px] sm:tracking-wide md:my-4 text-center'>REGISTER AS ADMIN</h3> 
            ...
            <input type="submit" value="REGISTER" className='bg-black text-white text-center p-2 border rounded-lg cursor-pointer border-none' />
            </form>
